...
export const FloatingNav = ({
  ...
  return (
    <motion.div
      className={cn(
        "flex w-[80%] fixed top-10 inset-x-0 mx-auto border border-white/[0.2] rounded-full bg-black/20 backdrop-blur-md shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1)] z-[5000] px-8 py-2 items-center justify-between",
        className
      )}
    >
      {/* Logo */}
